...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" action="${orders}?id">
            <input class="form-control mr-sm-2" name="order_id" type="search" required placeholder="<fmt:message key="search_id"/>" autocomplete="off" aria-label="Search">
                                    ...
                                    <form action="${orders}" method="post">
                                        ...
                                        <td>
                                            <button class="btn btn-info"
                                                    ...
                                                    value="${order.id}"><fmt:message key="confirm"/>
                                            </button>
                                        </td>
                                    </form>
                                    <form action="${orders}" method="post">
                                        ...
                                        <td>
                                            <button class="btn btn-info"
                                                    ...
                                                    value="${order.id}"><fmt:message key="deny"/>
                                            </button>
                                        </td>
                                    </form>
                                </c:if>
                                    ...
                                    <form action="${orders}" method="post">
                                        ...
                                        <td>
                                            <button class="btn btn-info"
                                                    type="submit"
                                                    name="complete"
                                                    value="${order.id}"><fmt:message key="complete"/>
                                            </button>
                                        </td>
                                    </form>
                                </c:if>
                                    ...
                                    <form action="${orders}" method="post">
                                        ...
                                        <td>
                                            <button class="btn btn-info"
                                                    ...
                                                    value="${order.id}"><fmt:message key="extend"/>
                                            </button>
                                        </td>
                                    </form>
                                </c:if>
                ...
                <ul class="pagination pagination-lg justify-content-center">
                    <c:if test="${current_page != 1}">
                        <li class="page-item"><a class="page-link a-nav"
                                                 href="${orders}?page=${current_page - 1}&show=${show}"><fmt:message key="previous"/> </a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${current_page lt num_of_pages}">
                        <li class="page-item"><a class="page-link a-nav"
                                                 href="${orders}?page=${current_page + 1}&show=${show}"><fmt:message key="next"/></a>
                        </li>
                    </c:if>
                </ul>
            </nav>
