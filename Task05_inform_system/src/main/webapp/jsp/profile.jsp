...
<head>
    ...
    <link rel="icon" href="https://cdn1.savepice.ru/uploads/2019/4/17/5ae5758165638c1db1af157878d0e2a9-full.png"
          type="image/jpg">
    <link rel="stylesheet" href="http://localhost:8080/freeride/css/profile.css"
          type="text/css"/>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><input value="Sign up" type="button" onclick="window.location='http://localhost:8080/freeride/jsp/signup.jsp'"
                class="btn btn-success navbar-btn btn-circle"
