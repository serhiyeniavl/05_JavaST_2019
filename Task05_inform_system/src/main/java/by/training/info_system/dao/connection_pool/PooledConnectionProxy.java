...
public class PooledConnectionProxy implements Connection, Comparable<PooledConnectionProxy> {
     ...
     * @param conn .
     */
    public PooledConnectionProxy(final Connection conn) {
        this.connection = conn;
    }

    void expireConnection() throws SQLException {
        connection.close();
    }
     ...
     */
    @Override
    public void setAutoCommit(final boolean autoComm) throws SQLException {
     ...
     */
    @Override
    public int compareTo(PooledConnectionProxy o) {
